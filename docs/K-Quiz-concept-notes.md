...
graphs and the Semantic Web, potentially developed as a KurrawongAI
offering.

The idea began as a "quick quiz" of perhaps six questions, but evolved
...
**K-Quiz** is currently preferred, particularly because it follows the
existing **K-Maker** naming pattern. This could allow a KurrawongAI
"K-\*" product family to emerge naturally without needing to define one
formally in advance.

Possible presentation:

> **K-Quiz**\
> The weekly RDF quiz from KurrawongAI.

"K-Quiz" also gives a pleasing RDF prefix:

``` turtle
@prefix kquiz: <https://ontology.kurrawong.ai/kquiz/> .

kquiz:domain
kquiz:questionType
kquiz:responseFormat
kquiz:assessmentMethod
```

------------------------------------------------------------------------

## 3. What the quiz is for
...
**K-Quiz is an engagement layer for KurrawongAI expertise.**
...
6.  encounter deeper KurrawongAI resources where relevant.

This is marketing by **demonstrating competence rather than asserting
competence**.

The wider KurrawongAI training/resource model could be relatively
passive:

> Here are useful resources. Use them if they help. Contact us if you
> need help applying this to your own data.

The quiz becomes the front door.

A possible path is:

**Question → answer → explanation → deeper resource → help applying this
to your data → KurrawongAI**
...
A countdown timer probably is not desirable. It risks making the
experience feel like an examination and introduces accessibility issues.
...
editorial/generation machinery.

After several weeks, regular users may notice patterns. That is fine and
...
## 7. Response format is another dimension
...
## 8. Assessment method is yet another dimension
...
## 9. Feedback is distinct from assessment
...
## 10. Candidate question patterns
...
## 11. How obscure may the subject matter be?
...
## 13. Agent-generated, but editor-checked
...
ex:q27
    a kquiz:Question ;
    kquiz:domain kquiz:RDFS ;
    kquiz:questionType kquiz:Inference ;
    kquiz:responseFormat kquiz:MultipleChoice ;
    kquiz:assessmentMethod kquiz:ExactMatch ;
    kquiz:difficulty kquiz:Medium ;
...
## 15. Namespace / IRI design

A possible KurrawongAI-owned ontology namespace:

``` text
https://ontology.kurrawong.ai/kquiz/
```
...
It may be useful to distinguish ontology terms from published quiz
instances:

``` text
https://ontology.kurrawong.ai/kquiz/    ontology/vocabulary terms
https://quiz.kurrawong.ai/...           quizzes, questions, responses, etc.
```

Example:

``` turtle
<https://quiz.kurrawong.ai/2026/01/question/7>
    a kquiz:Question ;
    kquiz:domain kquiz:RDFS ;
    kquiz:questionType kquiz:Inference .
```

A KurrawongAI-controlled namespace is not necessarily "proprietary" in a
problematic sense. KurrawongAI can own and govern the identifiers while
openly publishing the ontology with an open licence, dereferenceable
IRIs, RDF and HTML representations, and a clear versioning policy.

Indeed, publishing K-Quiz this way could itself demonstrate the Linked
Data practices KurrawongAI recommends to customers.

Before minting persistent terms, however, it would be worth discussing
whether this should establish a more general **KurrawongAI namespace/IRI
policy**. Changing application styling later is trivial; changing
published persistent identifiers is not.

------------------------------------------------------------------------

## 16. Potential longer-term capabilities
